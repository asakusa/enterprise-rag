...
class EnterpriseRAGFinal:
    def __init__(self):
        ...
        self.kb_name = "enterprise-kb"  # 缩短名称
        self.agent_name = "enterprise_doc_assistant"  # 缩短名称
    ...
    def create_knowledge_base(self):
        ...
        self.kb_id, self.ds_id = self.kb_helper.create_or_retrieve_knowledge_base(
            self.kb_name,
            kb_description="企业文档知识库：政策、IT支持、财务制度",
